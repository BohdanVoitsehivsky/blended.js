...
// const result = user.filter(us => us.age > 20)
...
//  const client = new Client("BOGDAN", "slkdvk")
//  console.log(client);
...
// const emp = new Employee("Олена", 28, "жінка", "olena@example.com", 12000, "Маркетинг");
